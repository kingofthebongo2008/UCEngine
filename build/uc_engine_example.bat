...
echo ^<ItemGroup^> >> %example_name%_h.msbuild
...
echo ^<ItemGroup^> >> %example_name%_cpp.msbuild
...
echo ^<ItemGroup^> >> %example_name%_hlsl.msbuild
...
echo ^<ItemGroup^> >> %example_name%_pso.msbuild
