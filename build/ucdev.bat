...
ucdev_build_file_generator_r.exe --input ..\src\app\private\uwp\posenet\shaders\ --mode hlsl >> ucdev_app_hlsl.msbuild
...
ucdev_build_file_generator_r.exe --input ..\src\app\private\uwp\posenet\shaders\ --mode pso >> ucdev_app_pso.msbuild
...
ucdev_build_file_generator_r.exe --type filters --input ..\src\app\private\uwp\posenet\shaders\ --mode hlsl >> ucdev_app.vcxproj.filters
...
ucdev_build_file_generator_r.exe --type filters --input ..\src\app\private\uwp\posenet\shaders\ --mode pso >> ucdev_app.vcxproj.filters
