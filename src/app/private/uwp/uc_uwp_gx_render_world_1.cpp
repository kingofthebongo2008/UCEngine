...
namespace uc
{
    namespace uwp
    {
        namespace gxu
        {
            ...
            gx::dx12::managed_graphics_command_context render_world_1::do_render(render_context* ctx)
            {
                //now start new ones
            ...
            gx::dx12::managed_graphics_command_context render_world_1::do_render_depth(render_context* ctx)
            {
