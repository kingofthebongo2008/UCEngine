        ...
        namespace gxu
        {
            ...
            std::unique_ptr< submitable >render_world_non_linear_moment_shadow_maps_64::do_render_shadows(shadow_render_context* ctx)
            {
                ...
                
                {
                    ...
                    graphics->transition_resource(ctx->m_shadow_map, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE, D3D12_RESOURCE_STATE_RENDER_TARGET | D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
